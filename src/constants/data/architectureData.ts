...
export const ARCHITECTURE_DATA = [
    {
        img: "/img/architecture/shortform-erd-v2.png",
        title: "숏폼 플랫폼 ERD",
        text: `3학년 1학기 여름방학부터 시작해서 만든 프로젝트의 ERD,
            테이블이 많아서 컬럼명이 보이지 않으면`,
        link: ["https://dayoon07.github.io/text/shortform-erd-v2.txt", " **이 링크로 이동**"]
    },
    {
