        ...
        <footer className="py-6 border-t border-gray-300 bg-gray-200">
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                <p className="mt-2 text-gray-400 text-sm">
                    ...
                    <br className="md:hidden" /> Inspired by&nbsp;
                    <a href="https://github.com/academicpages/academicpages.github.io" target="_blank" rel="noreferrer" className="hover:underline">
                        AcademicPages
                    </a>, reimplemented <br className="md:hidden" /> with React for personal use.
                </p>
            </div>
        </footer>
    );
