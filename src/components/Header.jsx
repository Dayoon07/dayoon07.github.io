  ...
  return (
    <header className="md:fixed w-full bg-white border-b">
      <div className="max-w-screen-xl mx-auto p-2 flex">
        <Link to="/" className="p-2 text-lg font-semibold font-semibold relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-0 after:h-[4px] after:bg-black after:transition-all after:duration-300 hover:after:left-0 hover:after:w-full cursor-pointer">dayoon07</Link>
