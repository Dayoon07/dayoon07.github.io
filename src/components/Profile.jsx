            ...
            <div className="space-y-4">
                        ...
                        <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded shadow-lg z-10">
                            <div className="p-4 space-y-3">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <a href="https://github.com/dayoon07" className="hover:underline" rel="noreferrer">dayoon07</a>
                                </div>
                            </div>
                        </div>
                    )}
                ...
                <div className="space-y-2 hidden md:block">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <a href="mailto:gangd0642@gmail.com" className="hover:underline" rel="noreferrer">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <a href="https://github.com/dayoon07" target="_blank" className="hover:underline" rel="noreferrer">dayoon07</a>
                    </div>
                </div>
            </div>
        </div>
